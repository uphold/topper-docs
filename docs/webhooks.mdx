...
| [`user:kyc:initiated`](./events/user.mdx#userkycinitiated) | User's KYC process has been initiated. |
| [`user:kyc:succeeded`](./events/user.mdx#userkycsucceeded) | User's KYC process has succeeded. |
| [`user:kyc:failed`](./events/user.mdx#userkycfailed) | User's KYC process has failed. |
