...
:::caution
If you pass a set of allowed target assets and also define the target asset as an asset that is not included on the allowed set, an error will occur when creating the widget session.

Also, if you don't set any asset as target and there is a set of allowed target assets, we'll default the target asset to the first asset on the allowed set.
:::
...
```js
{
  ...
  "data": {
    ...
    "destination": {
      ...
      "rate": "0.00056488387749632223",
      "asset": "ETH",
      "blockchainUrl": "https://etherscan.io/tx/0xdfa1ea4ddb841af466a5ca78c6e1f0edfaef5e54e79a28238d2a5bb2da4f1911",
      "ledger": {
